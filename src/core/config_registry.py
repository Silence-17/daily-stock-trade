...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "VNPY_AUTO_RECONNECT_ENABLED": {
        ...
        "description": "Run an opt-in background monitor that reconnects only when the configured gateway explicitly reports failed or disconnected state.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "VNPY_AUTO_RECONNECT_INTERVAL_SECONDS": {
        ...
        "description": "Seconds between opt-in gateway connection checks and reconnect attempts, clamped to 5-3600 seconds.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "VNPY_AUTO_RECONNECT_CONFIRMATION_GRACE_SECONDS": {
        ...
        "description": "Seconds allowed for an accepted asynchronous connect request to confirm before auto reconnect may retry it.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
