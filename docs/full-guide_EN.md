...
- **Historical A-share stamp duty** - `sell_tax_mode=cn_historical_stamp_duty` resolves sell-side stamp duty from each execution date: 10 bps from 2008-09-19 and 5 bps from 2023-08-28. Every sell audits the effective `tax_bps` and policy source. The mode rejects non-CN markets and fails closed for sells before the covered start date; `explicit` preserves the fixed `sell_tax_bps` contract. Sources: [Ministry of Finance 2008 single-sided collection notice](https://www.mof.gov.cn/zhengwuxinxi/caizhengxinwen/200809/t20080919_76432.htm) and [MOF/STA Announcement No. 39 of 2023](https://fgk.chinatax.gov.cn/zcfgk/c102416/c5211343/content.html).
